//https://www.vegas.com/gaming/gaming-tips/craps/
public class CrapsGame
{
	private int point;
	
	//Roll a 7 or 11 -> you win.
	//Roll a 2,3, or 12 -> you loose.
	...
	//Rename variables: highlight the name, right click,
	// refactor, rename, type new name, hit enter.
	...
	public boolean playOneGame(int[] wins, int[] losses)
	{
		...
		if (point == 7 || point == 11)
		{
			return playerRollsAWin(wins, steps);
		}
		else if (point==2 || point == 3 || point==12)
		{
			return playerRollsALoss(losses, steps);
		}
...
//			}
	...
	private boolean playerRollsALoss(int[] losses, int steps)
	{
	...
	private boolean playerRollsAWin(int[] wins, int steps)
	{
